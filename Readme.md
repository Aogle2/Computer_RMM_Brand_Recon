## Project Intro
Hello, this is a revision of the original project that I had build during my time at Code:Louisville.
This has the same idea as the OG project, but with some changes to code layout.
This is just a small idea on how presenting data can be done and should give an idea the diversity of Operating Systems, Vendors and Manufacturers.
